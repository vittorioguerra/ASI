...
write_def results/enfasi.def
write_timing_model results/enfasi.lib
write_abstract_lef results/enfasi.lef
write_verilog results/enfasi.v


set a [exec /vlsi/tools/scripts/OpenRoad/lef_patch results/enfasi.lef results/enfasi_final.lef]
puts $a
